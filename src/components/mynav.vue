...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
  ...
  <div id="navbarCollapse" class="collapse navbar-collapse flex-container">
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item"><a href="/adminhome" class="nav-link">Admin</a></li>
    ...
    <ul class="nav navbar-nav navbar-right ml-auto" v-if="statu == false">
      ...
      <li class="nav-item" v-show="isConnected == false">
      ...
      <li class="nav-item" v-show="!isConnected">
      ...
      <li class="nav-item" v-show="isConnected">
        <a @click="logout" class="btn btn-primary dropdown-toggle get-started-btn mt-1 mb-1">deconnexion</a>
      </li>
    </ul>
  </div>
</nav>
